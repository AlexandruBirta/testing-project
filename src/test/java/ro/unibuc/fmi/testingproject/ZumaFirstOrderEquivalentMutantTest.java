...
class ZumaFirstOrderEquivalentMutantTest {
    ...
    */
    ...
    final ZumaFirstOrderEquivalentMutant zumaFirstOrderEquivalentMutant = new ZumaFirstOrderEquivalentMutant();
    ...
    void givenInvalidBoardAndHandWhenFindMinimumOfStepsIsCalledThenReturnOutputForInvalidInputs(String board, String hand) {
        ...
        int actualOutput = zumaFirstOrderEquivalentMutant.findMinimumOfSteps(board, hand);
